...
if (isset($_POST['width'])){
	$config['relative_image_creation_width'][0] = $_POST['width'];
	$config['relative_image_creation_width'][1] = $_POST['width'];
	$config['relative_image_creation_height'][0] = $_POST['height'];
	$config['relative_image_creation_height'][1] = $_POST['height'];
}
