...
$config = array(
	...
	*/
	...
	'ext_file'                                => array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'ico' ), //Files
	 ...
	 *******************/
	'aviary_active'                           => false,
	'aviary_apiKey'                           => "9f31af1caedb47859e1755f9f4a11f08",
	'aviary_secret'                           => "8eaa97e2-e423-4127-ae44-494005c1a09c",
	...
	'relative_image_creation_height'          => array( 300, 300 ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
