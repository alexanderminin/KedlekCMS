var tour = new Tour({
  ...
  steps: [
  {
    ...
    title: "Категория",
    content: "Запись должна принадлежать определенной категории (если список пуст, значит у васеще нет категорий и их необходимо <a href='/category/addcategory' target='_blanc'>создать</a>",
    placement: "top"
  },
  {
  ...
  },
  {
    ...
    title: "Миниатюра",
    content: "Текущая миниатюра записи, если вы ее изменили, то она обновится только после нажатия на копку Сохранить.",
    placement: "top"
  },
  {
  ...
  },
  {
    element: "#add_button",
    title: "Сохранение",
    content: "После заполнения полей нажимеам кнопку Сохранить",
    placement: "right",
