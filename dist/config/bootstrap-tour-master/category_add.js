var tour = new Tour({
  ...
  steps: [
  {
    element: "#category_param",
    title: "Создание категории",
    content: "Необходимо заполнить заголовок категории и ее адрес",
    placement: "top"
  },
  {
    element: "#category_param_url",
    title: "Адрес категории",
    content: "Адрес категории должен быть написан латинецей и без пробелов (вместо пробелов можно использовать символ ' _ ' )",
    placement: "top"
  },
  {
    element: "#seo_param",
