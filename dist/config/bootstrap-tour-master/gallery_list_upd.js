var tour = new Tour({
  ...
  },
  {
    ...
    title: "Описание",
    content: "Краткое описание содержимого раздела (эта та часть текста которая всплывает в поисковых системах при поиске)",
    placement: "top"
  },
  {
  ...
  },
  {
    element: "#add_button",
    title: "Сохранение",
    content: "После заполнения полей нажимеам кнопку Сохранить раздел",
    placement: "right",
