...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_554618f7dcef79_60925908',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_554618f7dcef79_60925908')) {function content_554618f7dcef79_60925908($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru">
...
<head>
    ...
    <meta name="keywords" content="тестовая,категория сатйта" />
    <meta name="description" content="тестовая категория для сайта">
    <meta name="author" content="Boldrich.ru">
    <link rel="shortcut icon" href="/images/favicon.ico">

    <title>тестовая Категория - Питомник Болдрич Виктори</title>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <p>Compellingly conceptualize quality processes after interactive e-markets. Phosfluorescently productize user-centric deliverables before client-centric methods of empowerment. Objectively transition cooperative materials vis-a-vis equity invested imperatives. Quickly synthesize resource sucking models with resource maximizing results. Objectively plagiarize strategic channels vis-a-vis interactive leadership.</p>
         
                </div>
            </div>
        </div>
        <div class="panel-footer">2015-04-22 20:13:06 <a href="/record/pervaja_zapis">Подробнее</a></div>
    </div>
</div>

<div class="col-lg-12 col-md-12 col-xs-12">
    <div class="panel panel-default">
        <div class="panel-heading">Вторая запись</div>
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                   
                  <div>Monotonectally customize orthogonal technologies via competitive systems. Progressively strategize premier relationships vis-a-vis premium human capital. Continually plagiarize intermandated e-services via visionary channels. Seamlessly exploit worldwide e-commerce rather than synergistic web services. Completely productivate web-enabled metrics via standardized models.</div>
<div>&nbsp;</div>
<div>Monotonectally grow state of the art alignments for clicks-and-mortar materials. Interactively seize emerging initiatives after synergistic internal or "organic" sources. Proactively implement functionalized e-services through customer directed markets. Monotonectally fabricate team.</div>
         
                </div>
            </div>
        </div>
        <div class="panel-footer">2015-04-22 20:13:00 <a href="/record/vtoraja_zapis">Подробнее</a></div>
    </div>
</div>

<div class="col-lg-12 col-md-12 col-xs-12">
    <div class="panel panel-default">
        <div class="panel-heading">Третья запись</div>
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                   
                  <p>Dynamically implement error-free convergence rather than innovative ROI. Uniquely disintermediate visionary growth strategies vis-a-vis wireless benefits. Energistically re-engineer ethical vortals with&nbsp;</p>
         
                </div>
            </div>
        </div>
        <div class="panel-footer">2015-04-22 20:13:06 <a href="/record/tretja_zapis">Подробнее</a></div>
    </div>
</div>

<div class="col-lg-12 col-md-12 col-xs-12">
    <div class="panel panel-default">
        <div class="panel-heading">Во все тяжкие</div>
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                   
                  <p><span style="color: #333333; font-family: arial, sans-serif; font-size: 12px; line-height: 18px;">Школьный учитель химии Уолтер Уайт узнаёт, что&nbsp;болен раком лёгких. Учитывая сложное финансовое состояние дел&nbsp;семьи, а&nbsp;также перспективы, Уолтер решает заняться изготовлением метамфетамина. Для&nbsp;этого он&nbsp;привлекает своего бывшего ученика Джесси Пинкмана, когда-то исключённого из&nbsp;школы при&nbsp;активном содействии Уайта. Пинкман сам&nbsp;занимался &laquo;варкой мета&raquo;, но&nbsp;накануне, в&nbsp;ходе рейда ОБН, он&nbsp;лишился подельника и&nbsp;лаборатории&hellip;</span></p>
         
                </div>
            </div>
        </div>
        <div class="panel-footer">2015-04-22 16:16:00 <a href="/record/vo_vse_tjazhkie">Подробнее</a></div>
    </div>
</div>
